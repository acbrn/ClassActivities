...
// ? what do you expect ?
//console.log(total);
// it will throw an error due to the total not being defined outside of the function
...
//the last console.log in parentAndChildScope will not print because it is trying to go outside of the scope
