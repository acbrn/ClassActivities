...
//This function only returns "undefined" and does not return anything since it "return" is not apart of the code.
...
// No this function should not short circuit, there is no return statement in middle of the function.
...
function checkCircusRides() {
  ...
  return ("All your bases are mine!")
  console.log("Enjoy the roller coaster!");
}